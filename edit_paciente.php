<?php
    ...
    if (isset($_POST['update'])) {
        ...
        $query = "UPDATE paciente set nombrePaciente='$nombrePaciente', direccion='$direccion', telefono='$telefono', email='$email', imagen='$imagen',estado='$estado' WHERE idPaciente='$idPaciente'";
    ...
    <header>
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            ...
            <div class="container mt-2 d-flex justify-content-center ">
                ...
                <form action="edit_paciente.php?idPaciente=<?php echo $_GET['idPaciente']; ?>" method="POST" class="col-5 db_editar">
